...
class EmbeddingSharedWeights(tf.layers.Layer):
    ...
    def __init__(self, vocab_size, hidden_size, method="gather"):
        ...
        Args:
          ...
          method: Strategy for performing embedding lookup.
            "gather" uses tf.gather
            which performs well on CPUs and GPUs, but very poorly on TPUs.
        ...
        self.vocab_size = vocab_size  # size of dict
